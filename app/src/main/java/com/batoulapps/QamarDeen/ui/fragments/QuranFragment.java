        ...
        public void onClick(View v) {
            if (v.getId() == R.id.daily_button) {
                if (!mIsStandardReadingMode) {
                    ...
                    TextView hdrText =
                            hdr.findViewById(R.id.quran_hdr_daily_readings);
    ...
    private class QuranListAdapter extends QamarListAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                h.dailyReadings =
                        convertView.findViewById(R.id.daily_readings);
                h.ayahCount =
                        convertView.findViewById(R.id.ayah_count);
                h.jumpImage =
                        convertView.findViewById(R.id.jump_image);
                h.extraReadings =
                        convertView.findViewById(R.id.extra_readings);
